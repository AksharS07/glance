...
VDI.UI = (function() {
  ...
  var NATIVE_SVGS = {
    spotify: {
      ...
      repeatOne: '<svg viewBox="0 0 16 16" fill="currentColor"><path d="M0 4.75A3.75 3.75 0 0 1 3.75 1h8.5A3.75 3.75 0 0 1 16 4.75v5a3.75 3.75 0 0 1-3.75 3.75H9.81l1.018 1.018a.75.75 0 1 1-1.06 1.06L6.939 12.75l2.829-2.828a.75.75 0 1 1 1.06 1.06L9.811 12h2.439a2.25 2.25 0 0 0 2.25-2.25v-5a2.25 2.25 0 0 0-2.25-2.25h-8.5A2.25 2.25 0 0 0 1.5 4.75v5A2.25 2.25 0 0 0 3.75 12H5v1.5H3.75A3.75 3.75 0 0 1 0 9.75z"></path><text x="8" y="9.5" font-family="CircularSp, Circular, Spotify Circular, Inter, sans-serif" font-size="7.5px" font-weight="700" text-anchor="middle">1</text></svg>'
    },
    youtube: {
      ...
      repeat: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M21 13h-1v5H4v-5H3v6h18v-6zM3 11h1v-5h16v5h1v-6H3v6z"></path><path d="M17 14l4-4-4-4v3H6v2h11v3z"></path></svg>',
  ...
  function createController(island, lyrPanel, stgPanel, platform, opts) {
    ...
    function updateUI() {
      ...
      if ($('vdi-shuffle')) {
        ...
        var normalShufSvg = NATIVE_SVGS[p].shuffle;
        var smartShufSvg = NATIVE_SVGS[p].smartShuffle || normalShufSvg;
        ...
        if (state.shuffleOn) {
          ...
          if (state.smartShuffleOn) {
            ...
            $('vdi-shuffle').innerHTML = state.shufSvg || normalShufSvg;
