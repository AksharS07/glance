    ...
    let collapseTimeout = null; // For delayed collapse behavior
    ...
    function applyTrack(index) {
      ...
      // Keep track of original BG color to revert AMOLED properly
    ...
    // --- FIXED ISLAND CONTROLS (1:1 mimic of extension behavior) ---
    island.addEventListener('mouseenter', () => {
      clearTimeout(collapseTimeout);
      island.classList.add('vdi-expanded');
    });
    island.addEventListener('mouseleave', () => {
      // Clear old timeout and set new one (500ms delay to match UI.js)
      clearTimeout(collapseTimeout);
